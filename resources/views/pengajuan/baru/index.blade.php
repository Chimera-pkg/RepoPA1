                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h5 class="card-title">List Pengajuan Barang Baru | (Manager)</h5>
...
@section('addScript')
    ...
    <script>
        function onClickConfirm(id) {                                            
            Swal.fire({
                title: 'Confirm Data',
                text: "Apakah Anda yakin ingin mengizinkan pengajuan barang ini ?",
                icon: "warning",
                showDenyButton: true,
                dangerMode: true,
            ...
            .then((willDelete) => {
                if (willDelete.isConfirmed) {
                    $.ajax({
                        url: '/pengajuan/gudang/baru/update-status/' + id,
                        method: 'PUT',
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
                            ...
                            columnDefs: [{
                                ...
                                
                                {
                                    ...
                                    render: function(e, t, a, n) {
                                        ...
                                        return ('<button ' + (!a.status_manajer ? 'onclick="onClickConfirm(' + a.id + ')"' : '') + '" class="btn btn-sm btn-' + color + '">' + status + '</button>');
                                    },
                                },

                                {
                                    ...
                                    render: function(e, t, a, n) {
                                        ...
                                        return (a.status_manajer ? '<button class="btn btn-sm btn-' + color + '">' + status + '</button>' : "(Belum mendapat izin)");
                                    },
                                },
                            ],
                            order: [
