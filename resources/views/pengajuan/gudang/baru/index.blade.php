                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h5 class="card-title">List Pengajuan Barang Baru | Yang Belum Ada (Gudang)</h5>
                            ...
                            @include('offcanvas.add_new_pengajuan_barang_baru')
    ...
    <script>
        function onClickConfirm(id) {                                            
            ...
            .then((willDelete) => {
                if (willDelete.isConfirmed) {
                    $.ajax({
                        url: '/pengajuan/gudang/baru/update-status-sampai/' + id,
                        method: 'PUT',
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
        ...
        $(document).ready(function() {
            ...
            $('#addNewUserForm').submit(function(e) {
                ...
                var informasi_barang = $('#informasi_barang').val();
                

                $.ajax({
                    url: "{{ route('pengajuan.gudang.baru.store') }}",
                    method: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "nama_barang": nama_barang,
                        "jumlah_barang": jumlah_barang,
                        "informasi_barang": informasi_barang,
                    },
                    success: function(response) {
                        //close offcanvas
            ...
            $(function() {
                    ...
                    o.length &&
                        ...
                        s.length &&
                        (e = s.DataTable({
                            ajax: "{{ route('pengajuan.baru.index.data') }}",
                            columns: [{
                                    data: "id",
                                }, {
                                    data: 'pengaju',
                            ...
                            buttons: [{
                                ...
                                {
                                    text: '<i class="bx bx-plus me-0 me-lg-2"></i><span class="d-none d-lg-inline-block">Tambah Pengajuan Data Barang Baru</span>',
