            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <button class="btn btn-primary mb-4" style="width: 20%;" onclick="show('<?= route('barang_masuk.create') ?>')"><i class="bx bx-plus me-0 me-lg-2"></i><span class="">Tambah Barang</button>
                        @endif
                    ...
                    <div class="card-datatable table-responsive">
                        <table id="myTable" class="datatables-users table border-top">
                            ...
                            <tbody>
                                @php $x=1 @endphp
                                @foreach($barang_masuk as $data) <tr>
                                    <td>{{$x++}}</td>
                                    <td>{{$data->id}}</td>
